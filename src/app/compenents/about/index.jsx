  ...
  return (
	...
	<section  className="w-full h-screen lg:block item-center justify-center sm:grid">
		...
		<div ref={divRef} className="p-6 w-64  backdrop-blur-3xl shadow-lg rounded-lg border justify-center items-center border-white custom-bg block">
			<div className='proim justify-center items-center flex '><Image src={pi} className='border-10 border-white block rounded-full '></Image></div>
...
web applications using a variety of technologies.
			...
			<img className="w-full h-auto object-cover" src="https://github-readme-stats.vercel.app/api?username=Vidu1999&theme=transparent&hide_border=true&title_color=" alt="vidura1999" loading="lazy" />
</ItemLayout>	
<ItemLayout className={'col-span-2 row-span-4'}>
<div className="">
<img className="w-full h-auto" src="https://github-readme-stats.vercel.app/api/top-langs?username=Vidu1999&theme=transparent&hide_border=true&title_color=FEFESB&text_color=FFFFFF&
icon_color=FEFE5B&text_bold=false" alt="vidura1999" loading="lazy" />
</div>
</ItemLayout>	</div>
<div ref={divRef} className='w-full flex justify-center mr-5'>
<ItemLayout className={"h-auto"}>
<img className="w-full h-[200px]" src="https://skillicons.dev/icons?i=appwrite,aws,babel,bootstrap,cloudflare,css,d3,docker,figma,firebase,gatsby,git,github,graphql,html,ipfs,js,jquery,kubernetes,linux,mongodb,mysql,netlify,nextjs,nodejs,npm,postgres,react,redux,replit,sass,supabase,tailwind,threejs,vercel,vite,vscode,yarn" alt="CodeBucks" loading="lazy" />
</ItemLayout></div>
<div className='grid w-full lg:flex justify-center mr-5'>
<ItemLayout className={"col-span-6 !p-0"}>
<img src="https://streak-stats.demolab.com/?user=Vidu1999&theme=dark&hide_border=true&background=EB545400&ring=FEFE5B&currStreakLabel=FEFE5B" alt="GitHub Streak" />
</ItemLayout>
<ItemLayout className={"col-span-6 !p-0"}>
 <img className="w-full h-auto" src="https://github-readme-stats.vercel.app/api/pin/?username=codebucks27&repo=Nextjs-contentlayer-blog&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false" alt="CodeBucks" loading="lazy" />
</ItemLayout>
</div>
	</section>
	</>
